  ...
  <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/css/bootstrap.min.css" integrity="sha384-MCw98/SFnGE8fJT3GXwEOngsV7Zt27NXFoaoApmYm81iuXoPkFOJwJ8ERdknLPMO" crossorigin="anonymous">
      ...
      <body>
        <div class="container col-md-8">
          ...
          <br>
          <form id="frmEdtProd" name="frmEdtProd" method="POST" action="AdcProd.php">
          ...
          <div class="form-group">
            <label for="lblDesc"> Descrição: <?php echo $edita['descricao'] ?> </label>
            <input type="hidden" id="txtDesc" name="txtDesc" value = "<?php echo $edita['descricao'] ?>">
            ...
            <input type="text" id="txtValor" name="txtValor" 
                  ...
                  <input type="button" id="bt_Cancel" name="bt_Cancel"
                        ...
                        onclick="javascript:location.href='ItemPedido.php?compra=$compra'">
          </form>
          </div>
